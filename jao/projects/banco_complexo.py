...
"""))
        if qtd_saq > self.saldo:
          ...
          self.saldo = qtd_saq - self.saldo
          self.ver_historico.append(f"Saque de {qtd_saq} realizado com sucesso!")
...
"""))
        if qtd_dep > 100000:
          ...
          self.ver_historico.append(f"Deposito de {qtd_dep} realizado com sucesso!")
